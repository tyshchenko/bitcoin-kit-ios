...
class EDAValidator: IBlockValidator {
    private let difficultyEncoder: IBitcoinSVDifficultyEncoder
    private let blockHelper: IBitcoinSVBlockValidatorHelper
    private let maxTargetBits: Int
    private let firstCheckpointHeight: Int

    init(encoder: IBitcoinSVDifficultyEncoder, blockHelper: IBitcoinSVBlockValidatorHelper, maxTargetBits: Int, firstCheckpointHeight: Int) {
