...
class BitcoinSVValidatorHelperTests: QuickSpec {

    override func spec() {
        var helper: BitcoinSVBlockValidatorHelper!

        beforeEach {
            helper = BitcoinSVBlockValidatorHelper(coreBlockValidatorHelper: MockIBlockValidatorHelperWrapper())
        }
