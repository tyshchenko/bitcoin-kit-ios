Pod::Spec.new do |spec|
  spec.name = 'BitcoinSVKit.swift'
  spec.module_name = "BitcoinSVKit"
  spec.version = '0.9.0'
  spec.summary = 'BitcoinSV library for Swift'
  spec.description = <<-DESC
                       BitcoinSVKit implements BitcoinSV protocol in Swift. It is an implementation of the BitcoinSV SPV protocol written (almost) entirely in swift.
                       ```
                    DESC
  ...
  spec.source_files = 'BitcoinSVKit/BitcoinSVKit/**/*.{h,m,swift}'
